...
Alternatively, you can expand the link below and copy and paste the code into a shiny new Python file: 
...
Alternatively, you can expand the link below and copy and paste the code into a shiny Python file: 
